...
import com.dreytech.serverdreymart.Adapter.MenuAdapter;
...
public class HomeActivity extends AppCompatActivity
    ...
    private void showAddCategoryDialog() {
        ...
        builder.setTitle("Menambah Kategori baru");
        ...
        builder.setNegativeButton("BATAL", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                {
                    Toast.makeText(HomeActivity.this, "Isi nama kategori", Toast.LENGTH_SHORT).show();
                    return;
                }
                if (uploaded_img_path.isEmpty())
                {
                    Toast.makeText(HomeActivity.this, "Pilih gambar untuk kategori", Toast.LENGTH_SHORT).show();
                    return;
                }
